...
import { FaSearch, FaExchangeAlt, FaBell, FaCog, FaUser, FaBars, FaRobot, FaGift, FaHotel, FaUtensils, FaCar, FaPlane, FaTrain, FaStar, FaHeart, FaReply, FaThumbsUp, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaPhone, FaEnvelope, FaMapMarkerAlt, FaClock, FaCcVisa, FaCcMastercard, FaGooglePay, FaPaypal, FaSearchLocation, FaMapMarkedAlt, FaRoute } from 'react-icons/fa';
